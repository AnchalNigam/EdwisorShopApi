    ...
    let categoryCreationFunction = () => {
        return new Promise((resolve, reject) => {
            if (check.isEmpty(req.body.categoryName)) {
                ...
                logger.error(`Error Occured : Required Parameters are missing!`, 'Category Controller: createCategory', 10);
        ...
        .exec((err,result)=>{
         if (err) {
            ...
            res.send(apiResponse)
             ...
             let apiResponse=response.generate(false,"Category Deleted successfully!",200,null);
             res.send(apiResponse)
